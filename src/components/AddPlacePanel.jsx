  ...
  async function search(event) {
    ...
    try {
      const next = nearbyOnly && pickedPoint
        ? await searchNearbyPlaces(boardId, { ...pickedPoint, q: value, radius }, { signal: controller.signal })
