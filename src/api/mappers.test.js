    ...
    items: [
      {
        ...
        transferCount: 1,
        totalWalkMinutes: 7,
        route: { legs: [{ mode: "SUBWAY", routeName: "수도권2호선", startName: "강남", endName: "신도림", durationMinutes: 28 }], path: [{ lon: 127.0276, lat: 37.4979 }, { lon: "bad", lat: 37.5 }, { lon: -999, lat: 37.5 }, { lon: 127, lat: 999 }, { lon: 126.8912, lat: 37.509 }] },
      },
      {
        participantId: "ptc-b",
        nickname: "정우",
